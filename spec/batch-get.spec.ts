...
describe('BatchGet', () => {
  @Dyngoose.$Table({ name: 'BatchGetTestCardTable1', backup: false })
  class TestTable1 extends Dyngoose.Table {
    @Dyngoose.$PrimaryKey('id')
    public static readonly primaryKey: Dyngoose.Query.PrimaryKey<TestTable1, number, void>
  ...
  @Dyngoose.$Table({ name: 'BatchGetTestCardTable2', backup: false })
  class TestTable2 extends Dyngoose.Table {
    @Dyngoose.$PrimaryKey('id')
    public static readonly primaryKey: Dyngoose.Query.PrimaryKey<TestTable2, number, void>
  ...
  it('should operate a successful batch operation', async () => {
    const batch = new Dyngoose.BatchGet<TestTable1 | TestTable2>()
  ...
  it('should operate a successful atomic batch operation', async () => {
    const batch = new Dyngoose.BatchGet<TestTable1 | TestTable2>().atomic()
    const item = TestTable1.primaryKey.fromKey(1)
  ...
  it('should not return records that were missing', async () => {
    const batch = new Dyngoose.BatchGet<TestTable1>()
