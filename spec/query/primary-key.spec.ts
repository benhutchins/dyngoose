...
describe('Query/PrimaryKey', () => {
  @Dyngoose.$Table({ name: 'QueryPrimaryKeyCardTable', backup: false })
  ...
  @Dyngoose.$Table({ name: 'QueryPrimaryKeyTableWithDateRange', backup: false })
  class TableWithDateRange extends Dyngoose.Table {
    @Dyngoose.$PrimaryKey('id', 'date')
    public static readonly primaryKey: Dyngoose.Query.PrimaryKey<TableWithDateRange, number, Date>
  ...
  let primaryKey: Dyngoose.Query.PrimaryKey<Card, number, string>
