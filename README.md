...
1. Define your attributes, indexes, tables and models using TypeScript classes.
2. Supports local migration and seeding for easy development.
3. Intelligent querying support optimizes use of indexes for queries when available.
4. Can convert tables into CloudFormation templates for you.
5. Powerful and simple querying.
6. Selectively updating item attributes.
