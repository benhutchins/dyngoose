import type { DeleteItemCommandOutput, PutItemCommandOutput, ReturnConsumedCapacity, UpdateItemCommandOutput } from '@aws-sdk/client-dynamodb'

import type { AttributeMap, DynamoReturnValues } from './interfaces'
